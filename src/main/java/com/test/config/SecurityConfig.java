...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http)
        ...
        // disabling the csrf token, this will affect the post put patch requests, if enabled
        ...
        http.authorizeHttpRequests(request ->
            request
                ...
                .permitAll()
                .// here we can specify the endpoints that we want to permit without authentication
                anyRequest()
                .authenticated()
        );
        ...
        // making the edpoints and requests stateless, so this will make the endpoint stateless and cannot use in the browser
    ...
    public AuthenticationProvider authenticationProvider() {
        // there are multiple authentication providers, we can use the dao authentication provider to check the users from the database
